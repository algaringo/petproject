    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locations', models.CharField(blank=True, max_length=20, null=True)),
                ('introductions', models.TextField(max_length=500)),
                ('status', models.CharField(blank=True, max_length=20, null=True)),
                ('rates', models.DecimalField(decimal_places=2, max_digits=15)),
